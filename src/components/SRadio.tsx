...
const SRadio = ({
	...
	const inputClass =
		'box-border mr-2.5 relative w-5.5 h-5.5 appearance-none rounded-full border border-Grey_Default transition-all checked:before:border-2 before:content[""] before:absolute before:block before:w-full before:h-full before:rounded-full before:top-2/4 before:left-2/4 before:-translate-y-2/4 before:-translate-x-2/4';
